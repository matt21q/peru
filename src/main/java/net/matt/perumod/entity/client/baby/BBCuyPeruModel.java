...
public class BBCuyPeruModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public BBCuyPeruModel(ModelPart root) {
	...
	public void setupAnim(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animate(((BBCuyPeruEntity) entity).idleAnimationState, ModBBAnimationsDeifinitions.IDLE, ageInTicks, 1f);
	}
