...
public class BBCuyIntiModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public BBCuyIntiModel(ModelPart root) {
	...
	public void setupAnim(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animate(((BBCuyIntiEntity) entity).idleAnimationState, ModBBAnimationsDeifinitions.IDLE, ageInTicks, 1f);
	}
