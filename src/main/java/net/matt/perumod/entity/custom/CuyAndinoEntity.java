...
public class CuyAndinoEntity extends Animal {
    private static final Ingredient FOOD_ITEMS = Ingredient.of(Items.CARROT, Items.APPLE, Items.WHEAT, Items.SUNFLOWER);
    public CuyAndinoEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    public @Nullable AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        return ModEntities.BB_CUY_ANDINO.get().create(level());
    }
