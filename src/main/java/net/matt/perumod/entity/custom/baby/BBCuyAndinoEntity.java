...
public class BBCuyAndinoEntity extends Animal {
    ...
    public BBCuyAndinoEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    private void transformToAdult() {
        ...
        CuyAndinoEntity adultEntity = ModEntities.CUY_ANDINO.get().create(this.level());
        if (adultEntity != null) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new FollowParentGoal(this, 1.1D) {
            ...
            public boolean canUse() {
                return super.canUse() && getParent() instanceof CuyAndinoEntity;
            }
        });
    ...
    public @Nullable AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        BBCuyAndinoEntity offspring = new BBCuyAndinoEntity(ModEntities.BB_CUY_ANDINO.get(), pLevel);
